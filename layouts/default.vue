  ...
  <v-app id="app">
    ...
    >
      ...
      <v-toolbar-title class="font-weight-black headers">
        أخبار فيروس كورونا<span class="pink--text"> (COVID-19)</span>
      </v-toolbar-title>
    </v-app-bar>
    <v-content>
    ...
    >
      ...
      <div class=" mb-4 title font-weight-light grey--text text--lighten-1 text-center">
        &copy; {{ (new Date()).getFullYear() }} — Vuango — Made with 💜 by Sohep Alslamat
      </div>
    </v-footer>
  </v-app>
</template>
